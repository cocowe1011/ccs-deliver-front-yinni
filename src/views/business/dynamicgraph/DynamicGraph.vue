      ...
      <div>
        ...
        <div class="card-content" style="display: flex;justify-content: center;" ref="parent">
          <div class="dyscare chuansongpadding" style="width: 900px;height: 100%;position: relative;" ref="child">
            ...
            <div class="show-data-area" style="position: absolute;left: 0px;top: 15px;width: 280px;" v-show="orderMainDy.photoFlag === '1'">
              <div class="show-data-area-top" style="width: 120px">{{ $t('dynamicGraph.shouxiangbiaoqian') }}</div>
              <div class="show-data-area-content" style="width: 160px;">
                <el-input readonly size="small" v-model="firstLabelCode"></el-input>
              </div>
            </div>
            <div class="show-data-area" style="position: absolute;left: 0px;top: 53px;width: 280px;" v-show="orderMainDy.photoFlag === '1'">
              <div class="show-data-area-top" style="width: 120px">{{ $t('dynamicGraph.weixiangbiaoqian') }}</div>
              <div class="show-data-area-content" style="width: 160px;">
        ...
        if(newVal === '1') { //货物开始进入A点
          ...
          if(this.nowNumberTurns == 1) {
            ...
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box：' + boxImitateId + 'enters point A', 'log');
            }
          } else {
            ...
            if(this.arrGH[0] != undefined) {
              ...
              if(this.arrGH[0].numberTurns < this.arrGH[0].totalNumberTurns) {
                ...
                if(this.$i18n.locale === 'zh') {
                  ...
                  this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box：' + this.nowABoxImitateId + 'enters point A', 'log');
                }
              }
            }
          }
        ...
        if(newVal === '1') { //货物开始进入B点
          if(this.arrAB.length > 0) {
            ...
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateId + 'enters point B，computing time：L1-length：' + this.l11  + ' Beam Speed：' + this.lightBeamRealTimeSpeed  + ' Set Beam Speed：' + this.orderMainDy.sxSpeedSet + ' L2-length：' + this.l2 + ' Speed ratio under the beam' + this.shuxiaSpeedProportion + ' total time：' + times, 'log');
            }
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The emergency stop button on the conveyor line has been pressed!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The emergency stop button for the conveyor line has been pressed!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The emergency stop of the transmission line electrical box has been pressed!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Conveyor line frequency conversion overload!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Overload of frequency conversion on the conveyor line under the bundle!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' In non flipping mode, the flipping fork is not unloaded!', 'error')
          }
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Flip machine malfunction alarm!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Eliminate institutional malfunction alarms!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Bundle the incoming materials and block them!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Blockage during shipment due to bundling!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The accelerator is not allowed to enter before the goods arrive at the chain plate, and the alarm is stopped!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Central mechanism operation over limit alarm!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box blockage alarm at 113 flipping position in non flipping mode!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Alarm for box blockage at 114 flipping position in non flipping mode!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The unloading box was not unloaded and mistakenly entered the flipping mechanism!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Accelerator emergency stop!', 'error')
          }
        }
      }
    },
      ...
      handler(newVal, oldVal){
        if(newVal == this.firstLabelCode) {
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The first box passes through point A, scan the code information:' + newVal, 'log')
          }
  ...
  methods: {
            ...
            if(!status) {
              ...
              if(index < this.arrBC.length - 1) {
                ...
                if(this.$i18n.locale === 'zh') {
                  ...
                  this.arrBC[index + 1].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Unqualified boxes appear before and after the goods, suspected to be unqualified！';
                }
              }
              // 给前一个箱子赋值不合格  
              if(index >= 1) {
    ...
    judgeAccData(accData, boxImitateIdVal) {
      ...
      if(index != -1) {
        ...
        if(accData.beam != undefined && accData.beam != null) {
          if (Number(this.orderMainDy.slLowerLimit) > Number(accData.beam) || Number(this.orderMainDy.slUpperLimit) < Number(accData.beam)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum value of beam current setting：' + this.orderMainDy.slLowerLimit + '，Beam current setting maximum value：' + this.orderMainDy.slUpperLimit + '，Beam reading value：' + accData.beam, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum value of beam current setting：' + this.orderMainDy.slLowerLimit + '，Beam current setting maximum value：' + this.orderMainDy.slUpperLimit + '，Beam reading value：' + accData.beam;
            }
            return false;
          } 
        } else {
        ...
        if(accData.power != undefined && accData.power != null) {
          if (Number(this.orderMainDy.glLowerLimit) > Number(accData.power) || Number(this.orderMainDy.glUpperLimit) < Number(accData.power)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum power setting value：' + this.orderMainDy.glLowerLimit + '，Maximum power setting value：' + this.orderMainDy.glUpperLimit + '，Power reading value：' + accData.power, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum power setting value：' + this.orderMainDy.glLowerLimit + '，Maximum power setting value：' + this.orderMainDy.glUpperLimit + '，Power reading value：' + accData.power;
            }
            return false;
          } 
        } else {
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' 货物' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum power setting value：' + this.orderMainDy.glLowerLimit + '，Maximum power setting value：' + this.orderMainDy.glUpperLimit + '，Power reading value：' + accData.power, 'log');
            this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' 货物' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum power setting value：' + this.orderMainDy.glLowerLimit + '，Maximum power setting value：' + this.orderMainDy.glUpperLimit + '，Power reading value：' + accData.power;
          }
          return false;
        }
        // 判断扫宽 scanW
        ...
        if(accData.scanW != undefined && accData.scanW != null) {
          if (Number(this.orderMainDy.skLowerLimit) > Number(accData.scanW) || Number(this.orderMainDy.skUpperLimit) < Number(accData.scanW)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum scanning width setting：' + this.orderMainDy.skLowerLimit + '，Scan width setting maximum value：' + this.orderMainDy.skUpperLimit + '，Scan width reading value：' + accData.scanW, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum scanning width setting：' + this.orderMainDy.skLowerLimit + '，Scan width setting maximum value：' + this.orderMainDy.skUpperLimit + '，Scan width reading value：' + accData.scanW;
            }
            return false;
          } 
        } else {
        ...
        if(accData.scanF != undefined && accData.scanF != null) {
          if (Number(this.orderMainDy.smplLowerLimit) > Number(accData.scanF) || Number(this.orderMainDy.smplUpperLimit) < Number(accData.scanF)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum scanning frequency setting：' + this.orderMainDy.smplLowerLimit + '，Set the maximum scanning frequency：' + this.orderMainDy.smplUpperLimit + '，Scan frequency reading value：' + accData.scanF, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum scanning frequency setting：' + this.orderMainDy.smplLowerLimit + '，Set the maximum scanning frequency：' + this.orderMainDy.smplUpperLimit + '，Scan frequency reading value：' + accData.scanF;
            }
            return false;
          } 
        } else {
        ...
        if(accData.pfn != undefined && accData.pfn != null) {
          if (Number(this.orderMainDy.pfnLowerLimit) > Number(accData.pfn) || Number(this.orderMainDy.pfnUpperLimit) < Number(accData.pfn)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! PFN voltage setting minimum value：' + this.orderMainDy.pfnLowerLimit + '，PFN voltage setting maximum value：' + this.orderMainDy.pfnUpperLimit + '，PFN voltage reading value：' + accData.pfn, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! PFN voltage setting minimum value：' + this.orderMainDy.pfnLowerLimit + '，PFN voltage setting maximum value：' + this.orderMainDy.pfnUpperLimit + '，PFN voltage reading value：' + accData.pfn;
            }
            return false;
          } 
        } else {
        ...
        if(accData.energy != undefined && accData.energy != null) {
          if (Number(this.orderMainDy.nlLowerLimit) > Number(accData.energy) || Number(this.orderMainDy.nlUpperLimit) < Number(accData.energy)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum energy setting value：' + this.orderMainDy.nlLowerLimit + '，Maximum energy setting value：' + this.orderMainDy.nlUpperLimit + '，Energy reading value：' + accData.energy, 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Minimum energy setting value：' + this.orderMainDy.nlLowerLimit + '，Maximum energy setting value：' + this.orderMainDy.nlUpperLimit + '，Energy reading value：' + accData.energy;
            }
            return false;
          } 
        } else {
        ...
        if(accData.speed != undefined && accData.speed != null) {
          if (Number(this.orderMainDy.sxSpeedLowerLimit) > (Number(accData.speed) * 1000) || Number(this.orderMainDy.sxSpeedUpperLimit) < (Number(accData.speed) * 1000)) {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Set the minimum value of the speed under the beam：' + this.orderMainDy.sxSpeedLowerLimit + '，Maximum speed setting under the beam：' + this.orderMainDy.sxSpeedUpperLimit + '，Speed reading value under the beam：' + (Number(accData.speed) * 1000), 'log');
              this.arrBC[index].failReason = moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'The craftsmanship is not up to standard! Set the minimum value of the speed under the beam：' + this.orderMainDy.sxSpeedLowerLimit + '，Maximum speed setting under the beam：' + this.orderMainDy.sxSpeedUpperLimit + '，Speed reading value under the beam：' + (Number(accData.speed) * 1000);
            }
            return false;
          } 
        } else {
        ...
        if(this.$i18n.locale === 'zh') {
          ...
          this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'Process qualified！', 'log');
        }
      } else {
        // 找不着直接默认合格
        if(this.$i18n.locale === 'zh') {
    ...
    testAcc() {
      HttpUtil.get('/box/getAccData').then((res)=> {
        this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Acc database return：' + JSON.stringify(res), 'log');
      }).catch((err)=> {
        this.$message.error(this.$i18n.locale === 'zh' ? 'Connect Acc Database Error！Reason：' : 'Failed to connect to the accelerator! Reason：' + err)
        this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Connect Acc Database Error！Reason：' + err, 'log');
      });
    },
    // 拿到模拟id去判断箱子的工艺是否合格
    getUndercutProcess(boxImitateIdVal) {
      ...
      if(this.$i18n.locale === 'zh') {
        ...
        this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + boxImitateIdVal + 'Arriving below the beam, start reading accelerator values！', 'log');
      }
      // 无加速器时放开此注释********************************************
      this.qualified4Box(boxImitateIdVal, true)
      this.$message.success(this.nowShuXiaid + 'pass！');
      // 无加速器时放开此注释*********************************************
      ...
      switch (dropZoneId) {
        case 'AB':
          ...
          this.$notify({
            ...
            message: 'Successfully moved to A-B Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
        ...
        case 'BC':
          ...
          this.$notify({
            title: 'Move successful！',
            message: 'Successfully moved to B-C Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
        ...
        case 'CD':
          ...
          this.$notify({
            title: 'Move successful！',
            message: 'Successfully moved to C-D Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
        ...
        case 'DG':
          ...
          this.$notify({
            title: 'Move successful！',
            message: 'Successfully moved to D-G Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
        ...
        case 'F':
          ...
          this.$notify({
            title: 'Move successful！',
            message: 'Successfully moved to F Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
        ...
        case 'GH':
          ...
          this.$notify({
            title: 'Move successful！',
            message: 'Successfully moved to G-H Area',
            position: 'top-left',
            offset: 70,
            duration:0,
            type: 'success'
      ...
      switch (point) {
        ...
        if(this.nowNumberTurns == 1) {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrAB[this.arrAB.length - 1].boxImitateId + 'Leave point A and scan the code information：' + this.loadScanCode, 'log');
          }
          break;
        case 'B':
          // 把AB队列第一个货物出列，进入BC
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrBC[this.arrBC.length - 1].boxImitateId + 'After passing through point B, scan the code information：' + this.arrBC[this.arrBC.length - 1].loadScanCode, 'log');
          }
          break;
        case 'C':
          if(this.pointC === '1') {
            ...
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrCD[this.arrCD.length - 1].boxImitateId + 'After passing through point C, scan the code information：' + this.arrCD[this.arrCD.length - 1].loadScanCode, 'log');
            }
            // 允许切换订单
        ...
        case 'D':
          if(this.pointD === '1') {
            ...
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[this.arrDG.length - 1].boxImitateId + 'After passing through point D, scan the code information：' + this.arrDG[this.arrDG.length - 1].loadScanCode, 'log');
            }
          }
          break;
        case 'E':
        ...
        case 'G':
          if(this.pointG === '1') {
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[0].boxImitateId + 'After passing through point G, scan the code information：' + this.arrDG[0].loadScanCode + '。current ' + this.arrDG[0].numberTurns + ' Circle, remaining ' + (Number(this.arrDG[0].totalNumberTurns) - Number(this.arrDG[0].numberTurns)) + ' Circle', 'log');
            }
            // 判断是否符合下货条件
            if (this.arrDG[0].numberTurns >= this.arrDG[0].totalNumberTurns) {
              ...
              await HttpUtil.post('/box/save', param).then((res)=> {
                if(res.data == 1) {
                  this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[0].boxImitateId + '，Box report has been generated！', 'log');
                } else {
                  this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[0].boxImitateId + '，Failed to generate box report！', 'log');
                }
              }).catch((err)=> {
                this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[0].boxImitateId + '，Failed to generate box report！' + err, 'log');
              });
            }
            // 判断此箱子是否还属于当前订单
            if(this.arrDG[0].orderId === this.orderMainDy.orderId) {
              ...
              if ((this.arrDG[0].boxImitateId === this.judgeBanLoadBoxImitateId) && (this.arrDG[0].numberTurns < this.arrDG[0].totalNumberTurns)) {
                ...
                setTimeout(() => {
                  if(this.arrGH.length > 0) {
                    if(this.$i18n.locale === 'zh') {
                      ...
                      this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' The first box arrives at point H！', 'log');
                    }
                    this.judgeIfBoxOnH();
                  }
                }, times);
                if(this.$i18n.locale === 'zh') {
                  ...
                  this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[0].boxImitateId + '，This is the first box of this shipment, passing through the G-spot and setting the speed under the restraint：' + this.orderMainDy.sxSpeedSet + '，X1-Length：' + this.lengthOne + '，V1 Speed ratio：' + this.speedOne + '，X2-Length：'+ this.lengthTwo +'，V2 Speed ratio：' + this.speedTwo + '，Delay time to reach H point：' + this.newDelayPointTime + 'Calculate the total time required to reach point H：' + times, 'log');
                }
              }
              // 把DG队列第一个货物出列，进入GH
            ...
            if(this.arrGH[indexHBox].numberTurns >= this.nowNumberTurns) {
              ...
              if (this.arrGH[indexHBox].numberTurns >= this.arrGH[indexHBox].totalNumberTurns) {
                ...
                if(this.$i18n.locale === 'zh') {
                  ...
                  this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Shipment alarm!', 'error')
                }
                // 发送报警信号
                ...
                await HttpUtil.post('/box/save', param).then((res)=> {
                  if(res.data == 1) {
                    if(this.$i18n.locale === 'zh') {
                      ...
                      this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrGH[indexHBox].boxImitateId + '，Updated box report！', 'log');
                    }
                  } else {
                    if(this.$i18n.locale === 'zh') {
                      this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' 货物' + this.arrGH[indexHBox].boxImitateId + '，更新箱报告失败！', 'log');
                    } else {
                      this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' 货物' + this.arrGH[indexHBox].boxImitateId + '，Failed to update box report！', 'log');
                    }
                  }
                }).catch((err)=> {
                  if(this.$i18n.locale === 'zh') {
                    ...
                    this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' 货物' + this.arrGH[indexHBox].boxImitateId + '，Failed to update box report！' + err, 'log')
                  }
                  ;
                });
              }
        ...
        if(delayPointTime > 0) {
          if(!this.isDelayPointTime) {
            ...
            if(this.$i18n.locale === 'zh') {
              ...
              this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' H-point delay starts！', 'log');
            }
    ...
    calculateTotalTime() {
      ...
      if(!this.isDelayPointTime){
        this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' H-point delay starts，params：J-length:' + pointjLength + '|K-length:' + pointkLength + '|L-length:' + pointlLength + '|J-speed:' + jAreaSpeed + '|K-speed:' + kAreaSpeed + '|L-speed:' + lAreaSpeed, 'log');
      }
      // 检查长度是否不为负数且速度是否大于0
      if (pointjLength >= 0 && pointkLength >= 0 && pointlLength >= 0 && 
        ...
        if(!this.isDelayPointTime){
          this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Calculated delay time：' + totalTime + 'ms', 'log');
        }
        return totalTime;
      } else {
        // 如果输入不合法，返回0
        if(!this.isDelayPointTime){
          this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Calculated delay time：0', 'log');
        }
        return 0;
      }
    },
      ...
      if(this.arrDG[index].qualified === '0') {
        ...
        if(this.orderMainDy.trayFlag != '1') {
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[index].boxImitateId + 'After passing through point E, the goods are not qualified! Execute the remove command！', 'log');
          }
          ...
          if(this.$i18n.locale === 'zh') {
            ...
            this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[index].boxImitateId + 'After passing through point E, the goods are not qualified! Do not execute the reject command in tray mode！', 'log');
          }
        }
      } else {
        // 合格无需处理，写0即可
        ...
        if(this.$i18n.locale === 'zh') {
          ...
          this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Box' + this.arrDG[index].boxImitateId + ' After passing through point E, the goods are qualified！', 'log');
        }
      }
    },
    ...
    delayHpoint() {
      ...
      if(this.$i18n.locale === 'zh') {
        ...
        this.createLog(moment().format('YYYY-MM-DD HH:mm:ss') + ' Starting from H-point and ending with delay！', 'log');
      }
    },
    ...
    downClick() {
      this.$confirm( this.$i18n.locale === 'zh' ? '此操作将默认全部箱子已下货, 是否继续?' : 'This operation will assume that all boxes have been shipped. Do you want to continue?', 'Tip', {
        confirmButtonText: this.$i18n.locale === 'zh'?'确定':'YES',
        cancelButtonText: this.$i18n.locale === 'zh'?'取消':'NO',
        type: 'warning'
      }).then(() => {
        this.baojingShow = false;
        this.yujingShow = false;
